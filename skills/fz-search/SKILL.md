...
name: fz-search
description: >-
  프로젝트 코드 탐색 + 구조 분석 + 의존성 추적 스킬. 병렬 교차 검증으로 정확도 확보.
  Use when exploring code structure, tracing symbol dependencies, finding architecture relationships,
  or searching for code patterns across the project.
