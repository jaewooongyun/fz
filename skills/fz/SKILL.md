...
4. 진행/완료 보고 전 각 주장을 이 세션의 도구 결과와 대조 — 근거 지목 불가 항목은 `[미검증]` 명시 (Fable grounded progress 병합 [verified: platform.claude.com/docs/en/build-with-claude/prompt-engineering/prompting-claude-fable-5])
