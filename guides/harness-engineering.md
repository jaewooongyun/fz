...
| **컨텍스트 불안** | 긴 작업에서 일관성 상실 | Sonnet 4.5/4.6가 윈도우 한도 근처에서 조기 마무리 (Opus 4.6/4.7에서 개선, "shallow long-context adaptation" [partially-verified: cobusgreyling.medium.com/claude-opus-4-7-is-a-harness-release-354f92cd1648; A1 직접 진술 없음 — Claude 실측 별도 필요]) | Context Reset + 구조화된 핸드오프 |
...
**Anthropic의 재검토 사례** (Opus 4.6 → Opus 4.7 [verified: anthropic.com/news/claude-opus-4-7; supporting: cobusgreyling.medium.com/claude-opus-4-7-is-a-harness-release-354f92cd1648 — "Opus 4.7 is a harness release"]):

| 컴포넌트 | Sonnet 4.5 시절 | Opus 4.6 이후 | Opus 4.7 (2026-04-16 GA) | 변경 이유 |
|----------|---------------|-------------|--------------------------|----------|
| Sprint 분해 | 필수 (세분화 없으면 혼란) | **제거** | **유지 (4.6과 동일)** [partially-verified: A5 — A1 직접 진술 없음] | 계획 능력 향상으로 불필요 |
| 스프린트별 평가 | 매 스프린트마다 | **최종 1회만** | **유지 (최종 1회만)** [partially-verified: A5] | 장문 컨텍스트 능력으로 중간 점검 불필요 |
| Context Reset | 필수 (Compaction 불충분) | **선택** | **유지 (선택)** [partially-verified: A5]. tokenizer 1.00-1.35x 영향 [미검증: Korean 실측 부재] | Compaction 품질 향상 |
| Evaluator | 항상 실행 | **조건부** | **유지 (조건부)** [partially-verified: A5] | 단순 작업은 혼자 충분 |

> Length limits 시스템 프롬프트 (≤25 words 도구 간, ≤100 words 최종) 자동 적용 [community: cobusgreyling.medium.com/claude-opus-4-7-is-a-harness-release-354f92cd1648 — A1 직접 진술 없음, A5 해석].
...
예외: Opus 4.6+ 1M context는 Compaction 충분 [verified: Anthropic 2026.03 재검토 포스트].
     Opus 4.7에서도 동등 동작 [verified: anthropic.com/news/claude-opus-4-7; supporting: cobusgreyling.medium.com/claude-opus-4-7-is-a-harness-release-354f92cd1648 — "harness release"이지만 isolation 벤치마크는 modest, agent loop에서 gap 발생].
...
Anthropic 실제 사례:
  ...
  Opus 4.7 (2026-04-16 GA): Sprint 분해 유지 (4.6과 동일) + Length limits 시스템 프롬프트 신규 적용 [verified: anthropic.com/news/claude-opus-4-7; supporting: cobusgreyling.medium.com/claude-opus-4-7-is-a-harness-release-354f92cd1648]
...
| 6d | Introducing Claude Opus 4.7 | Anthropic | 2026-04-16 | https://www.anthropic.com/news/claude-opus-4-7 |
