...
**v4.39.0 — 별칭은 새 모델을 따라갔고 단가표는 따라가지 않았다.** Opus 5.5·GPT-6 Sol 출시에 `opus` 별칭은 자동으로 따라갔지만,
...
**v4.38.0 — 검사기는 있었고 부르는 곳이 없었다.** 호출처가 0건인 규칙·검사기·플래그가 다섯 번 나왔다. 검사기 신설 15·수정 6 을 전부 `health-check` 에 등재했다.
