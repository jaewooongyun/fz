...
├── modules/         45개 — gates(완료 게이트 SSOT), pipelines, cross-validation, lead-action-default, gpt-strategy, memory-guide, fz-gpt-bash-hygiene, fz-gpt-subcommands-core/aux ...
...
├── scripts/         42개 — gate_check(완료 판정기) · gate_stop_hook(종료 차단) · lint 3 · gpt-exec · health-check ...
