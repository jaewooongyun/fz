...
- **대안 패턴 / 구조 결정 옵션 테이블**: Q4에서 제시된 대안 + 현재 선택의 근거 + 핵심 구조 결정별 채택안·대안·1줄 trade-off (답습/미러링 작업이면 3축 필수, 핵심 구조 결정 없으면 N/A 1줄). PROCEED 판정이어도 plan에 포함하고 **사용자 보고 시 표로 제시** — 이유: 옵션은 기록이 아니라 제시가 목적 (OBS-12 불만 ①)
